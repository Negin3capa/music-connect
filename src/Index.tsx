...
import { Music, Users, Calendar, Star, Search, Guitar, Mic, PlayCircle, Shield, CreditCard, Sparkles } from "lucide-react";
...
const Index = () => {
  ...
  const musicGenres = [
    "Rock", "MPB", "Sertanejo", "Jazz", "Pop", "Blues", "Reggae", "Eletrônica", "Forró", "Samba", "Pagode", "Funk Brasileiro", "Trap", "Axé", "Bossa Nova", "Frevo", "Baião", "Piseiro", "Arrocha", "Xote"
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
              A plataforma que une músicos talentosos e contratantes em todo o Brasil. 
              <span className="text-primary font-semibold"> Encontre seu show ideal</span> ou 
              <span className="text-secondary font-semibold"> contrate o artista perfeito</span>.
            </p>
            ...
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 shadow-xl">
              ...
              <div className="mt-3 sm:mt-4 text-left">
                <p className="text-xs sm:text-sm text-muted-foreground mb-2">Gêneros populares:</p>
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {musicGenres.slice(0, 6).map((genre) => (
                    <Badge key={genre} variant="secondary" className="text-xs sm:text-sm cursor-pointer hover:bg-primary hover:text-primary-foreground transition-colors">
                      {genre}
                    </Badge>
                  ))}
                </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
            <Card className="text-center border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-xl group">
              <CardHeader>
                ...
                <CardDescription>
                  Músicos criam perfis detalhados com portfólio. Contratantes buscam por estilo, localização e disponibilidade.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center border-secondary/20 hover:border-secondary/40 transition-all duration-300 hover:shadow-xl group">
              <CardHeader>
                ...
                <CardDescription>
                  Negocie datas, valores e detalhes do evento. Confirme a contratação com segurança através da plataforma.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center border-accent/20 hover:border-accent/40 transition-all duration-300 hover:shadow-xl group">
              <CardHeader>
                ...
                <CardDescription>
                  Show realizado! Pagamento seguro liberado automaticamente. Avaliem uns aos outros para construir reputação.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8">
                Transforme sua paixão musical em oportunidades reais. Conecte-se com contratantes e aumente sua visibilidade no mercado musical.
              </p>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Portfólio Musical Completo</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Crie um perfil profissional com fotos, vídeos, links para streaming e histórico musical.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Gestão de Agenda</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Controle sua disponibilidade, preços por data e receba propostas de contratação.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Pagamento Garantido</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Sistema escrow garante que você receba pelo show realizado. Sem preocupações com inadimplência.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Card className="bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
                <CardContent className="p-4 sm:p-6 md:p-8">
                  <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                    ...
                    <div>
                      <h4 className="font-bold text-base sm:text-lg">João Silva</h4>
                      <p className="text-muted-foreground text-xs sm:text-sm">Violonista • MPB/Bossa Nova</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs sm:text-sm">4.9 (23 avaliações)</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <PlayCircle className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-primary shrink-0" />
                      <span className="text-xs sm:text-sm">12 shows realizados</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CreditCard className="h-3.5 sm:h-4 w-3.5 sm:w-4 text-green-500 shrink-0" />
                      <span className="text-xs sm:text-sm">R$ 300 - R$ 500 por show</span>
                    </div>
                  </div>
      ...
      {/* Para Contratantes */}
      <section id="para-contratantes" className="py-12 sm:py-16 px-4 bg-muted/30">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="lg:order-2">
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8">
                Encontre músicos profissionais para seus eventos. Do bar da esquina ao grande festival, temos o artista ideal para sua ocasião.
              </p>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Músicos Verificados</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Todos os artistas passam por verificação. Veja portfólio, avaliações e histórico de apresentações.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Contratação Segura</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Contratos digitais, pagamento via plataforma e garantia de comparecimento do artista.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Matchmaking Inteligente</h3>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Algoritmo sugere artistas ideais baseado no seu tipo de evento, orçamento e preferências musicais.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Card className="bg-gradient-to-br from-secondary/5 to-accent/5 border-secondary/20">
                <CardContent className="p-4 sm:p-6 md:p-8">
                  <div className="mb-4 sm:mb-6">
                    <h4 className="font-bold text-base sm:text-lg mb-2">Bar do João - Evento de Sexta</h4>
                  ...
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    ...
                    <div className="flex justify-between text-xs sm:text-sm">
                      ...
                      <span className="text-green-600 font-semibold">R$ 800</span>
                    </div>
                    <div className="flex justify-between text-xs sm:text-sm">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4">
                    <Badge variant="secondary" className="text-xs">Rock</Badge>
                    <Badge variant="secondary" className="text-xs">Nacional</Badge>
                    <Badge variant="secondary" className="text-xs">Banda</Badge>
                  </div>

                  <Button variant="hero" size="sm" className="w-full text-xs sm:text-sm">
                    Ver Candidatos
                  </Button>
                </CardContent>
              </Card>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gradient-to-r from-primary via-secondary to-accent">
        <div className="container mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
            Junte-se a milhares de músicos e contratantes que já estão fazendo história na MusicConnect.
          </p>
      ...
      <footer className="py-6 sm:py-8 px-4 bg-card border-t">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground text-xs sm:text-sm px-2">
            © 2024 MusicConnect. Conectando música e oportunidades em todo o Brasil.
          </p>
        </div>
      </footer>
    </div>
